# <a id="BTUpdater_BTUpdaterForm"></a> Class BTUpdaterForm

Namespace: [BTUpdater](BTUpdater.md)  
Assembly: BTUpdater.dll  

```csharp
public class BTUpdaterForm : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
### <a id="BTUpdater_BTUpdaterForm__ctor"></a> BTUpdaterForm\(\)

```csharp
public BTUpdaterForm()
```

## Methods

### <a id="BTUpdater_BTUpdaterForm_DelayStart"></a> DelayStart\(\)

```csharp
public void DelayStart()
```

### <a id="BTUpdater_BTUpdaterForm_Dispose_System_Boolean_"></a> Dispose\(bool\)
...
### <a id="BTUpdater_BTUpdaterForm_SilentInstall"></a> SilentInstall\(\)

```csharp
public Action SilentInstall()
```
