# <a id="BT_Base_Forms_PluginManagerBrowseControl"></a> Class PluginManagerBrowseControl
...
[WinRTExposedType(typeof(PluginManagerBrowseControlWinRTTypeDetails))]
public class PluginManagerBrowseControl : UserControl, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[PluginManagerBrowseControl](BT.Base.Forms.PluginManagerBrowseControl.md)
...
### <a id="BT_Base_Forms_PluginManagerBrowseControl__ctor"></a> PluginManagerBrowseControl\(\)

```csharp
public PluginManagerBrowseControl()
```

## Fields

### <a id="BT_Base_Forms_PluginManagerBrowseControl_descriptionLabel"></a> descriptionLabel
...
### <a id="BT_Base_Forms_PluginManagerBrowseControl_imagePanel"></a> imagePanel
...
### <a id="BT_Base_Forms_PluginManagerBrowseControl_lastUpdatedLabel"></a> lastUpdatedLabel
...
### <a id="BT_Base_Forms_PluginManagerBrowseControl_titleLabel"></a> titleLabel
...
### <a id="BT_Base_Forms_PluginManagerBrowseControl_versionLabel"></a> versionLabel
...
### <a id="BT_Base_Forms_PluginManagerBrowseControl_Dispose_System_Boolean_"></a> Dispose\(bool\)
