# <a id="BT_Base_Forms_LogOutputForm"></a> Class LogOutputForm
...
[WinRTExposedType(typeof(LogOutputFormWinRTTypeDetails))]
public class LogOutputForm : DockContent, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl, IDockContent, IContextMenuStripHost
```
...
DockContent ← 
[LogOutputForm](BT.Base.Forms.LogOutputForm.md)
...
### <a id="BT_Base_Forms_LogOutputForm__ctor"></a> LogOutputForm\(\)
...
### <a id="BT_Base_Forms_LogOutputForm_Dispose_System_Boolean_"></a> Dispose\(bool\)
