# <a id="BT_Base_Controls_PluginManagerInstalledControl"></a> Class PluginManagerInstalledControl

Namespace: [BT.Base.Controls](BT.Base.Controls.md)  
Assembly: BananasToolbox.dll  

```csharp
[WinRTRuntimeClassName("Windows.Foundation.IClosable")]
[WinRTExposedType(typeof(PluginManagerInstalledControlWinRTTypeDetails))]
public class PluginManagerInstalledControl : UserControl, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
### <a id="BT_Base_Controls_PluginManagerInstalledControl__ctor"></a> PluginManagerInstalledControl\(\)

```csharp
public PluginManagerInstalledControl()
```

## Methods

### <a id="BT_Base_Controls_PluginManagerInstalledControl_Dispose_System_Boolean_"></a> Dispose\(bool\)
