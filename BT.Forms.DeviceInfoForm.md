# <a id="BT_Forms_DeviceInfoForm"></a> Class DeviceInfoForm
...
[WinRTExposedType(typeof(DeviceInfoFormWinRTTypeDetails))]
public class DeviceInfoForm : DockContent, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl, IDockContent, IContextMenuStripHost
```
...
### <a id="BT_Forms_DeviceInfoForm__ctor"></a> DeviceInfoForm\(\)
...
### <a id="BT_Forms_DeviceInfoForm_Dispose_System_Boolean_"></a> Dispose\(bool\)
