# <a id="BT_Forms_OptionsForm"></a> Class OptionsForm
...
[WinRTExposedType(typeof(OptionsFormWinRTTypeDetails))]
public class OptionsForm : DockContent, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl, IDockContent, IContextMenuStripHost
```
...
### <a id="BT_Forms_OptionsForm__ctor"></a> OptionsForm\(\)
...
### <a id="BT_Forms_OptionsForm_OptionsTreeView"></a> OptionsTreeView
...
### <a id="BT_Forms_OptionsForm_Dispose_System_Boolean_"></a> Dispose\(bool\)
