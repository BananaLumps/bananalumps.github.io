# <a id="BT_Base_Forms_OptionForms_GeneralOptions"></a> Class GeneralOptions
...
[WinRTExposedType(typeof(GeneralOptionsWinRTTypeDetails))]
public class GeneralOptions : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
### <a id="BT_Base_Forms_OptionForms_GeneralOptions__ctor"></a> GeneralOptions\(\)
...
### <a id="BT_Base_Forms_OptionForms_GeneralOptions_Dispose_System_Boolean_"></a> Dispose\(bool\)
